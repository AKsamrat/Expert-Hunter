...
const JobCard = ({ job }) => {
  ...
  return (
    <Zoom duration={1000}>
      <div className="h-96">
        <div className="border border-[#00c1cb9b] rounded-xl p-5 shadow-2xl hover:translate-x-2 hover:scale-110 duration-150 h-full">
          <p className="text-lg font-semibold pb-3">{job_title}</p>
